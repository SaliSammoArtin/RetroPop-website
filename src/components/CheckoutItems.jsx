...
export default function CartItems({ items }) {
  ...
  return (
    <div className=" bg-retro-cream-bg text-retro-green-text border-2 border-retro-yellow-highlight rounded-xl shadow-lg max-w-2xl flex justify-between p-8 m-4">
