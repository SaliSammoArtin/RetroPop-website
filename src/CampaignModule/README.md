...
CampaignModule har även en combineDiscountsmetod som kombinerar flera samtidigt använda kampanjkoder till en enda prisspecifikation, genom att summera rabatterna. Den hölls separat från run() för att hålla den grundläggande metoden enkel och göra kombineringslogiken tydligt avgränsad.